function U=RadialGravityDerivative(mu,Rref,lmcosi,x,y,z,n)
...
V1=VWDiagonalRecursion(MaxDeg-1,x,y,rsquared,Rref,V0,W0);
W1=VWDiagonalRecursion(MaxDeg-1,x,y,rsquared,Rref,W0,-V0);    
