...
[a_up_o,~,~]=GravityComponents(ax_o,ay_o,az_o,xr,yr,zr,aref,cref);

a1_up_c=RadGravityAccelerationTriDen(x1',y1',z1',FV,xr,yr,zr,rho1,refell);
a2_up_c=RadGravityAccelerationTriDen(x2',y2',z2',FV,xr,yr,zr,rho2,refell);
a3_up_c=RadGravityAccelerationTriDen(x3',y3',z3',FV,xr,yr,zr,rho3,refell);

a_up_c=a1_up_c+a2_up_c+a3_up_c;
...
for i=1:Nelems   % computing jacobian
    ...
    a1_up_c_inc=RadGravityAccelerationTriDen(x1',y1',z1',FV,xr,yr,zr,rho1_inc,refell);
    a2_up_c_inc=RadGravityAccelerationTriDen(x2',y2',z2',FV,xr,yr,zr,rho2_inc,refell);
    
    J1n(:,i)=(a1_up_c_inc-a1_up_c)'/delta_rho;  
    J2n(:,i)=(a2_up_c_inc-a2_up_c)'/delta_rho;  
...
L=a_up_o-a_up_c; % initial residuals
...
a1_up_c=RadGravityAccelerationTriDen(x1',y1',z1',FV,xr,yr,zr,rho1_s,refell);
a2_up_c=RadGravityAccelerationTriDen(x2',y2',z2',FV,xr,yr,zr,rho2_s,refell);
a3_up_c=RadGravityAccelerationTriDen(x3',y3',z3',FV,xr,yr,zr,rho3_s,refell);
...
plot((L)./a_up_o*100,'.b');
plot((a_up_c-a_up_o)./a_up_o*100,'.r');
...
a1_up_c_re=RadGravityAccelerationTriDen(x1',y1',z1',FV,xre,yre,zre,rho1_s,refell);
a2_up_c_re=RadGravityAccelerationTriDen(x2',y2',z2',FV,xre,yre,zre,rho2_s,refell);
a3_up_c_re=RadGravityAccelerationTriDen(x3',y3',z3',FV,xre,yre,zre,rho3_s,refell);

a_up_c_re=a1_up_c_re+a2_up_c_re+a3_up_c_re;

clear a1_up_c_re a2_up_c_re a3_up_c_re
...
[a_up_o_re,~,~]=GravityComponents(ax_o_re,ay_o_re,az_o_re,xre,yre,zre,aref,cref);
...
a1_up_init=RadGravityAccelerationTriDen(x1',y1',z1',FV,xre,yre,zre,rho1,refell);
a2_up_init=RadGravityAccelerationTriDen(x2',y2',z2',FV,xre,yre,zre,rho2,refell);
a3_up_init=RadGravityAccelerationTriDen(x3',y3',z3',FV,xre,yre,zre,rho3,refell);

a_up_c_init=a1_up_init+a2_up_init+a3_up_init;

clear a1_up_init a2_up_init a3_up_init

a_res_init=a_up_o_re-a_up_c_init;
...
a_up_res_final=(a_up_c_re-a_up_o_re);

figure; 
set(gca,'FontSize',20);
hist(a_up_res_final(:)./a_up_o_re(:)*100,20);
xlabel('Residual potential [%]','FontSize',20);

%% Final potential resuduals
AGUaxes
pcolorm(fire,lambdare,a_up_res_final); shading interp;
% contourm(fir,lambdar,a,100,'Color','k'); shading interp;
% plotm(fii,lambdai,'wo','MarkerFaceColor','w','MarkerSize',9);
cbar=colorbar('FontSize',20);
