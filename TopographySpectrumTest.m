...
loglog(k_Moon,sdl_Moon,'r','MarkerFaceColor','r','LineWidth',2,'MarkerSize',1,'Marker','o',...
     'LineWidth',1);
loglog(k_Venus,sdl_Venus,'g','MarkerFaceColor','g','LineWidth',2,'MarkerSize',1,'Marker','o',...
 'LineWidth',1);
loglog(k_Mars,sdl_Mars,'b','MarkerFaceColor','b','LineWidth',2,'MarkerSize',1,'Marker','o',...
    'LineWidth',1);
loglog(k_Earth,sdl_Earth,'c','MarkerFaceColor','b','LineWidth',2,'MarkerSize',1,'Marker','o',...
    'LineWidth',1);
loglog(k_Vesta,sdl_Vesta,'m','MarkerFaceColor','b','LineWidth',2,'MarkerSize',1,'Marker','o',...
    'LineWidth',1);
