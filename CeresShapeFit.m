...
%% SH analysis
lmcosi_topo=xyz2plm(rad,10,'irr',lat*180/pi,lon*180/pi);
...
WriteXYZ(lon*180/pi,lat*180/pi,H/1000,'~/Dawn/CeresShapeModel/SPG/PreSurvey/global_H.dat');
...
[ ~, H_bi ] = cspice_nearpt( r_bi', radii_bi(1), radii_bi(2), radii_bi(3) );

WriteXYZ(lon*180/pi,lat*180/pi,H_bi/1000,'~/Dawn/CeresShapeModel/SPG/PreSurvey/global_Hbi.dat');
